...
var DayTableMixin = FC.DayTableMixin = {
	...
	renderHeadDateCellHtml: function(date, colspan, otherAttrs) {
		...
		return '' +
			'<th class="fc-day-header ' + view.widgetHeaderClass + classes.join(' ') + ' fc-' + dayIDs[date.day()] + '"' +
				(this.rowCnt == 1 ?
			...
			'><span class="bigday">' +
				...
				'</span><span class="smallday">' + htmlEscape(date.format(this.colHeadFormat)).substr(0,3) + '</span>' +
			'</th>';
	},
		...
		if (buttonStr) {
			$.each(buttonStr.split(' '), function(i) {
				...
				$.each(this.split(','), function(j, buttonName) {
					...
					if (buttonName == 'title') {
						groupChildren = groupChildren.add($('<span class="span-title">&nbsp;</span>')); // we always want it to take up height
						isOnlyButtons = false;
					}
					else {
